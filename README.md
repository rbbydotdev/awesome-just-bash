...
- [pydantic-ai-just-bash](https://github.com/nathan-gage/pydantic-ai-just-bash) — PydanticAI capability (`JustBash`) that gives agents a persistent virtual shell, exposing normal Pydantic AI tools as bash commands and supporting deferred tool discovery via `bash_list_tools`/`bash_search_tools`. ![](https://img.shields.io/github/stars/nathan-gage/pydantic-ai-just-bash?style=flat-square&label=%20&color=gray)
- [wterm](https://github.com/vercel-labs/wterm) — Web terminal emulator from Vercel Labs with a Zig/WASM VT100 core; ships `@wterm/just-bash` package for an in-browser bash shell powered by just-bash. ![](https://img.shields.io/github/stars/vercel-labs/wterm?style=flat-square&label=%20&color=gray)
- [just-bash-mcp](https://github.com/guillaumemaka/just-bash-mcp) — Second MCP server wrapping just-bash with Laminar observability tracing, configurable timeouts, and VS Code MCP integration support. ![](https://img.shields.io/github/stars/guillaumemaka/just-bash-mcp?style=flat-square&label=%20&color=gray)
- [dspy-just-bash-interpreter](https://github.com/dbreunig/dspy-just-bash-interpreter) — DSPy RLM wrapper (`BashRLM`) that gives a DSPy agent a persistent bash interpreter via the `just-bash` Python library. ![](https://img.shields.io/github/stars/dbreunig/dspy-just-bash-interpreter?style=flat-square&label=%20&color=gray)
